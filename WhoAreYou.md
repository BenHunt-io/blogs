...
But what does meaningful work have to do with making predictions on how to best survive? In the absence of the primal need to survive and reproduce we are left with gigantic optimizing function that is still trying to model the best future with us in it. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwOTU4NzE1NCwtMTcwNjE2MjQyMiw3Nj
