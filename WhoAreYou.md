...
Your umvelt, or subjective reality is built upon the permutation of these senses. This is a short list. I couldn't possibly list out every permutation, there are gradients to each attribute. For instance, there are thousands if not more levels to sweetness. My fingerprint is unique and it is such a minute attribute in the totality of my umvelt. Just because I interact uniquely with the world does not mean that defines who I am, it's just merely what I've been given to use. My tools.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NDE2MDIwLDE3Mzk3MTY0NjksMTI2MT
